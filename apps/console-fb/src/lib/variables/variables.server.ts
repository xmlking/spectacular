...
const schema = z.object({
  ...
  AUTH_PROVIDER_AZUREAD_CLIENT_ID: z.string().regex(/^\S*$/, {
    message: 'No spaces allowed',
  }),
  AUTH_PROVIDER_AZUREAD_CLIENT_SECRET: z.string().regex(/^\S*$/, {
    message: 'No spaces allowed',
  }),
  AUTH_PROVIDER_AZUREAD_TENANT: z.string().regex(/^\S*$/, {
    message: 'No spaces allowed',
  }),
  AUTH_PROVIDER_GITHUB_CLIENT_ID: z.string().regex(/^\S*$/, {
    message: 'No spaces allowed',
  }),
  AUTH_PROVIDER_GITHUB_CLIENT_SECRET: z.string().regex(/^\S*$/, {
    message: 'No spaces allowed',
  }),
  AUTH_PROVIDER_GOOGLE_CLIENT_ID: z.string().regex(/^\S*$/, {
    message: 'No spaces allowed',
  }),
  AUTH_PROVIDER_GOOGLE_CLIENT_SECRET: z.string().regex(/^\S*$/, {
    message: 'No spaces allowed',
  }),
  ...
  DIRECTORY_FILTER_DEVICE_PREFIX: z
    ...
    .optional(),
  MICROSOFT_GRAPH_ENDPOINT: z.string().url().regex(/^\S*$/, {
    message: 'No spaces allowed',
  }),
  MICROSOFT_GRAPH_TENANT_ID: z.string().regex(/^\S*$/, {
    message: 'No spaces allowed',
  }),
  MICROSOFT_GRAPH_CLIENT_ID: z.string().regex(/^\S*$/, {
    message: 'No spaces allowed',
  }),
  MICROSOFT_GRAPH_CLIENT_SECRET: z.string().regex(/^\S*$/, {
    message: 'No spaces allowed',
  }),
