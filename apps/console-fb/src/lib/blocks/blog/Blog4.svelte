<div class="mx-auto px-4 py-16 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8 lg:py-20">
  <div class="mb-10 divide-y border-b border-t">
    ...
    <div class="grid py-8 sm:grid-cols-4">
      ...
      <div class="sm:col-span-3 lg:col-span-2">
        ...
        <p class="text-gray-700">
          Chase ball of string eat plants, meow, and throw up because I ate plants going to catch the red dot today
          going.
        </p>
      </div>
    </div>
