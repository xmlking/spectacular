<div class="mx-auto mt-auto px-4 pt-16 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
    ...
    <div class="space-y-2 text-sm">
      ...
      <div class="flex">
        ...
        <a
          ...
          title="Our phone"
          class="text-deep-purple-accent-400 transition-colors duration-300 hover:text-deep-purple-800">850-123-5021</a
        >
      </div>
      <div class="flex">
  ...
  <div class="flex flex-col-reverse justify-between border-t pb-10 pt-5 lg:flex-row">
    ...
    <ul class="mb-3 flex flex-col space-y-2 sm:flex-row sm:space-x-5 sm:space-y-0 lg:mb-0">
      <li>
        <a href="/" class="text-sm text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400"
          >F.A.Q</a
        >
      </li>
      <li>
