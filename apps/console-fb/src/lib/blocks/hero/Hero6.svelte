  ...
  <div class="flex flex-col lg:flex-row">
    <div class="mx-auto mb-10 max-w-xl pr-16">
      ...
      <p class="mb-6 text-gray-900">
        ...
        quae. Sed ut unde omnis iste natus.
      </p>
    ...
    <div class="row-gap-5 grid gap-5 sm:grid-cols-2">
      <div class="max-w-md">
        ...
        <p class="text-sm text-gray-700">
          A flower in my garden, a mystery in my panties. Heart attack never stopped old Big Bear. I didn't even know we
      ...
      <div class="max-w-md">
        ...
        <p class="text-sm text-gray-700">
          A slice of heaven. O for awesome, this chocka full cuzzie is as rip-off as a cracker. Meanwhile, in behind the
          bicycle shed, Hercules.
        </p>
      </div>
      <div class="max-w-md">
        <div class="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-indigo-50">
        ...
        <p class="text-sm text-gray-700">
          Disrupt inspire and think tank, social entrepreneur but preliminary thinking think tank compelling. Inspiring,
          invest synergy capacity.
        </p>
      </div>
    </div>
  </div>
