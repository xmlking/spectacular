<div class="mb-16">
        ...
        >
          <span class="relative inline-block">
            <svg
              viewBox="0 0 52 24"
              fill="currentColor"
              class="absolute left-0 top-0 z-0 -ml-20 -mt-8 hidden w-32 text-gray-400 sm:block lg:-ml-28 lg:-mt-10 lg:w-32"
            >
              <defs>
  ...
  <div class="relative px-4 sm:px-0">
    ...
    <div
      class="relative mx-auto grid divide-y overflow-hidden rounded bg-white shadow sm:max-w-screen-sm sm:grid-cols-3 sm:divide-x sm:divide-y-0 lg:max-w-screen-md"
    >
