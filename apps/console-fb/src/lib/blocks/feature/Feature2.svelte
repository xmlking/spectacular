<section class="body-font text-gray-600 dark:text-gray-400">
  <div class="container mx-auto px-5 py-24">
    <div class="mb-20 flex w-full flex-col text-center">
      <h2 class="title-font mb-1 text-xs font-medium tracking-widest text-indigo-500 dark:text-indigo-400">
    ...
    <div class="-m-4 flex flex-wrap">
      ...
      <div class="p-4 md:w-1/3">
        <div class="flex h-full flex-col rounded-lg bg-gray-100 p-8 dark:bg-gray-700 dark:bg-opacity-60">
          ...
          <div class="flex-grow">
            <p class="text-base leading-relaxed">
              Visualize and understand API usage with the included analytics dashboard or integrate with popular tools
              like Grafana or Kibana.
            </p>
            <a href={'#'} class="mt-3 inline-flex items-center text-indigo-500 dark:text-indigo-400"
              >Learn More
              <svg
      ...
      <div class="p-4 md:w-1/3">
        <div class="flex h-full flex-col rounded-lg bg-gray-100 p-8 dark:bg-gray-700 dark:bg-opacity-60">
          ...
          <div class="flex-grow">
            <p class="text-base leading-relaxed">
              Make APIs consumable by publishing your APIs and their documentation to a developer portal.
            </p>
            <a href={'#'} class="mt-3 inline-flex items-center text-indigo-500 dark:text-indigo-400"
              >Learn More
              <svg
