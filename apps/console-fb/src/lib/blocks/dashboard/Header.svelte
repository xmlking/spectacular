...
<Navbar style="view-transition-name: header;" let:hidden let:toggle fluid={true} border={false} color="light">
  <div class="flex items-center">
    ...
    <NavBrand href="/">
      ...
      <span class="self-center whitespace-nowrap text-xl font-semibold">
        <span class="text-[#b1171c] dark:text-pink-500">Data</span><span class="text-[#515151] dark:text-white"
          >Blocks</span
        >
      </span>
    </NavBrand>
  ...
  <NavUl {hidden}>
    ...
    <NavLi data-sveltekit-preload-data="" href="/dashboard/policies" active={path == '/dashboard/policies'}
      >Policies</NavLi
    >
  ...
  {#if user}
    ...
    <div class="hidden md:block">
      <Avatar src={user.image ?? '/images/profile-picture-3.webp'} size="md" border referrerpolicy="no-referrer"
      ...
      <Dropdown arrowIcon={false} inline={true}>
        ...
        <DropdownDivider />
        <DropdownItem>
          <a href="/auth/signout?callbackUrl=/blog" data-sveltekit-preload-data="off" data-sveltekit-preload-code="off"
            >Sign Out</a
          >
        </DropdownItem>
      </Dropdown>
