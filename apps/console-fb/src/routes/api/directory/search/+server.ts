  ...
  try {
    switch (subType) {
      ...
      case subject_type_enum.device: {
        ...
        if (deviceErrors)
          throw new DeviceError('SEARCH_DEVICE_ERROR', 'list devices api error', deviceErrors[0] as GraphQLError);
      ...
      case subject_type_enum.device_pool: {
        ...
        if (poolErrors)
          throw new DeviceError('SEARCH_DEVICE_ERROR', 'list devices api error', poolErrors[0] as GraphQLError);
