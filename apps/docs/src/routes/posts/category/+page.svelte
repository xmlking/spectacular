<script lang="ts">
	...
	import { canonicalPageUrl, getFavicon, capitalizeFirstLetter } from '$lib/utils/strings';
	...
	<div class="page-wrapper__content">
			...
			{#each metadata as category}
				<h2>
					<a
						...
						href="{base}/posts/category/{category.name}">{category.name}</a
					>
				</h2>
				<ul>
		...
		{:else}
			<h2 class="message message--warning">
				Please, check all your content ensuring the YAML frontmatter contains "<i
					>category</i
				>".
			</h2>
		{/if}
