...
<section class="container grid items-center gap-6">
	<div class="flex max-w-[980px] flex-col items-start gap-2">
		<h1 class="text-3xl font-extrabold leading-tight tracking-tighter md:text-4xl">
			Privacy Policy for {PUBLIC_TERMS_PRIVACY_WEBSITE}
		</h1>
		...
		<p class="max-w-[700px] text-lg text-muted-foreground">
			{PUBLIC_TERMS_PRIVACY_COMPANY} does not sell or rent your personally identifiable information to anyone.
			We only disclose personally identifiable information about our users when we believe, in good faith,
			that either the law requires it, to protect the rights or property of {PUBLIC_TERMS_PRIVACY_COMPANY},
