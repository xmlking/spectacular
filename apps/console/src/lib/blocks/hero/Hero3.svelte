	...
	<div class="container mx-auto flex flex-col items-center px-5 py-24 md:flex-row">
		...
		>
			...
			<div class="flex justify-center">
				...
				>
				<button
					class="ml-4 inline-flex rounded border-0 bg-gray-100 px-6 py-2 text-lg text-gray-700 hover:bg-gray-200 focus:outline-none dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
					>Live demo</button
				>
			</div>
		</div>
