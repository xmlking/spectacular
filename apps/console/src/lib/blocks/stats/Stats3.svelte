...
>
	<div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
		<div class="text-center">
			<div
				class="bg-teal-accent-400 mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full sm:h-12 sm:w-12"
			>
				<svg
					class="h-8 w-8 text-teal-900 sm:h-10 sm:w-10"
					stroke="currentColor"
					viewBox="0 0 52 52"
				>
					<polygon
			...
			<h6 class="text-deep-purple-accent-400 text-4xl font-bold">819</h6>
		...
		<div class="text-center">
			...
			<h6 class="text-deep-purple-accent-400 text-4xl font-bold">1.3K</h6>
		...
		<div class="text-center">
			...
			<h6 class="text-deep-purple-accent-400 text-4xl font-bold">91</h6>
		...
		<div class="text-center">
			...
			<h6 class="text-deep-purple-accent-400 text-4xl font-bold">52</h6>
