...
---
CREATE TRIGGER log_deleted_record_when_public_subscriptions_deleted
  AFTER DELETE
  ON public.subscriptions
  FOR EACH ROW
EXECUTE FUNCTION public.log_deleted_record();
COMMENT ON TRIGGER log_deleted_record_when_public_subscriptions_deleted ON public.subscriptions IS 'trigger to save deleted records for audit';
