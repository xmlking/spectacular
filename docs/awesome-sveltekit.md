...
- Icons
  ...
  - [flowbite-svelte-icons](https://github.com/themesberg/flowbite-svelte-icons) 480+ SVG [Flowbite icons](https://flowbite.com/icons/) components for Svelte. list of icon [names](https://flowbite.com/icons/)
