/**
 * TODO: remove the file and add `"@types/dom-chromium-ai"` to `tsconfig.json` and `package.json` after PR merged
 * Draft PR: https://github.com/DefinitelyTyped/DefinitelyTyped/pull/70757
 * Source: https://github.com/DefinitelyTyped/DefinitelyTyped/blob/82d03d136501656d03fc26e48aa0c2903f40f988/types/dom-chromium-ai/index.d.ts
 */
